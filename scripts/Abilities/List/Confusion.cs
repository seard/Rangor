...
public class Confusion : AbilityTemplate {

    // Declare spellspecific variables here:
    public GameObject smokeEntity;
    ...
    public override void SpellStart()
    {
        ...
        GameObject o;
        o = Network.Instantiate(smokeEntity, GetComponent<Collider2D>().bounds.center, Quaternion.identity, 0) as GameObject;
        o.GetComponent<PullEntity>().targetTag = "Will";

        TargetIndicatorController.AOECircleIndicator(smokeSize);
    }
